...
object ScannerInput {
    ...
    /**
     * Read an int from the user within a range
     * If the entered data isn't actually an int or is out of range the user is prompted again to enter the int.
     *
     * @param prompt  The information printed to the console for the user to read
     * @param min  The smallest permitted value to be entered
